...
public class interests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myadapter= new ArrayAdapter<String>(interests.this,
        ...
        ArrayAdapter<String> myadapter2= new ArrayAdapter<String>(interests.this,
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(studentorcr.equals("student"))
                {
                    ...
                    Toast.makeText(interests.this, "SUCCESSFULLY CREATED Student", Toast.LENGTH_SHORT).show();
                    Intent moveTologin = new Intent(interests.this, MainActivity.class);
                ...
                else if (studentorcr.equals("con"))
                {
                    ...
                    Toast.makeText(interests.this, "SUCCESSFULLY CREATED CR", Toast.LENGTH_SHORT).show();
                    Intent moveTologin = new Intent(interests.this, MainActivity.class);
                    //startActivity(moveTologin);
                }
            }
